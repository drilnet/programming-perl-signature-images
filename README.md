...
<br>
[Example 1 (High Quality).jpg](https://github.com/drilnet/programming-perl-signature-images/raw/master/Example%201%20(High%20Quality).jpg)
<br>
[Example 2 (High Quality).jpg](https://github.com/drilnet/programming-perl-signature-images/raw/master/Example%202%20(High%20Quality).jpg)
...
<br>
Чтобы написать, удалите квадратные **скобки** и слово **ухо**, после чего, вставьте правильный знак.
